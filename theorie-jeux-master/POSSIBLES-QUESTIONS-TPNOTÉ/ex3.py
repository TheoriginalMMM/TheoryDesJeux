...
if __name__ == "__main__":
    ...
    for i in range(400):
        Strategie_prudente = Strategie_prudente(taille_jeux)
        Strategie_random = Strategie_random_Ndiv3(taille_jeux)
        joueur1 = Joueur(nbr_pierre, Strategie_prudente, 1)
        joueur2 = Joueur(nbr_pierre, Strategie_random, 2)
        
        if not cache is None:
            # joueur1.strategy.cache = cache
            joueur1.strategie.cache = cache
