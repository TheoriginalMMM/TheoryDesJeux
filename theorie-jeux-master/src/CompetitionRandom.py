...
if __name__ == "__main__":
    ...
    for i in range(len(taillesdeJeux)):
        ...
        StrategiePrincipale=Strategie_random(taillesdeJeux[i])
        OtherStrategies=[]
        ...
        for j in range(len(OtherStrategies)):
            ...
            if(OtherStrategies[j].getName()=="Strategie random"):
                Affronter(1000,StrategiePrincipale,OtherStrategies[j],taillesdeJeux[i],Nombres_Pierres[i],Strategi1UseCash=False,Strategi2UseCash=False)
            else:
                Affronter(1000,StrategiePrincipale,OtherStrategies[j],taillesdeJeux[i],Nombres_Pierres[i],Strategi1UseCash=False,Strategi2UseCash=True)